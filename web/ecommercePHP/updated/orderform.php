	...
	<div class="categolis">
		<table>
			<tr>
				...
				<th><a href="OurProducts/Cleaning.php" style="text-decoration: none;color: #040403;padding: 4px 12px;background-color: #e6b7b8;border-radius: 12px;">Cleaning</a></th>
				...
				<th><a href="OurProducts/Hygiene.php" style="text-decoration: none;color: #040403;padding: 4px 12px;background-color: #e6b7b8;border-radius: 12px;">Hygiene</a></th>
			</tr>
		</table>
	</div>
