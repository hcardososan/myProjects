...
<html>
	<head>
		<title>Welcome to goodbuy online shop</title>
	...
	<body style="min-width: 980px;">
		<div class="homepageheader" style="position: relative;">
			...
			<div style="float: left; margin: 5px 0px 0px 23px;">
				<a href="index.php">
					<img style=" height: 75px; width: 130px;" src="image/goodbuylogo.png">
				</a>
			</div>
			<div class="">
				<div id="srcheader">
		...
		<div class="home-welcome">
			<div class="home-welcome-text" style="background-image: url(image/homebackgrndimg.png); height: 380px; ">
				<h1 style="margin: 0px;">Welcome To Goodbuy</h1>
				<h2>Largest Online Shopping In the World</h2>
			</div>
		</div>
			...
			<div style="padding: 20px 30px; width: 85%; margin: 0 auto;">
				<ul style="float: left;">
					<li style="float: left; padding: 25px;">
						<div class="home-prodlist-img"><a href="women/bathrobes.php">
							<img src="./image/product/bathrobes/new-designer-fancy-look-attractive-bathrobes-2-original.jpg" class="home-prodlist-imgi">
							</a>
						</div>
					</li>
				</ul>
				...
				<ul style="float: left;">
					<li style="float: left; padding: 25px;">
						<div class="home-prodlist-img"><a href="women/hats.php">
							<img src="./image/product/bathrobes/hats 1.png" class="home-prodlist-imgi"></a>
						</div>
					</li>
				</ul>
				<ul style="float: left;">
					<li style="float: left; padding: 25px;">
						<div class="home-prodlist-img"><a href="women/toiletry1.php">
				...
				<ul style="float: left;">
					<li style="float: left; padding: 25px;">
						<div class="home-prodlist-img"><a href="women/tshirt.php">
							<img src="./image/product/bathrobes/tshirts1.png" class="home-prodlist-imgi"></a>
						</div>
					</li>
				</ul>
				<ul style="float: left;">
