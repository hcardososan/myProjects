...
<body>
	...
	<div class="categolis">
		<table>
			<tr>
				...
				<th><a href="toiletry1.php" style="text-decoration: none;color: #ddd;padding: 4px 12px;background-color: #24bfae;border-radius: 12px;">toiletry1</a></th>
			</tr>
		</table>
	</div>
	<div style="padding: 30px 120px; font-size: 25px; margin: 0 auto; display: table; width: 98%;">
		<div>
		<?php 
			$getposts = mysql_query("SELECT * FROM products WHERE available >='1' AND item ='toiletry1'  ORDER BY id DESC LIMIT 10") or die(mysql_error());
