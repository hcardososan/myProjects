...
<body>
	...
	<div class="categolis">
		<table>
			<tr>
				<th>
					<a href="bathrobes.php" style="text-decoration: none;color: #fff;padding: 4px 12px;background-color: #24bfae;border-radius: 12px;">bathrobes</a>
				</th>
				...
				<th><a href="hats.php" style="text-decoration: none;color: #ddd;padding: 4px 12px;background-color: #c7587e;border-radius: 12px;">hats</a></th>
				...
				<th><a href="toiletry1.php" style="text-decoration: none;color: #ddd;padding: 4px 12px;background-color: #c7587e;border-radius: 12px;">toiletry1</a></th>
			</tr>
		</table>
	</div>
	<div style="padding: 30px 120px; font-size: 25px; margin: 0 auto; display: table; width: 98%;">
		<div>
		<?php 
			$getposts = mysql_query("SELECT * FROM products WHERE available >='1' AND item ='bathrobes'  ORDER BY id DESC LIMIT 10") or die(mysql_error());
							...
							<ul style="float: left;">
								<li style="float: left; padding: 0px 25px 25px 25px;">
									<div class="home-prodlist-img"><a href="view_product.php?pid='.$id.'">
										<img src="../image/product/bathrobes/'.$picture.'" class="home-prodlist-imgi">
										</a>
