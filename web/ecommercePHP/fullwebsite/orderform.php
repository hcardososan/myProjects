...
//triming name
	try {
		...
		// Check if email already exists
						...
						";
						//if (@mail($uemail_db,"goodbuy Product Order",$msg, "From:goodbuy <no-reply@goodbuy.xyz>")) {
...
<body style="background-image: url(image/homebackgrndimg1.png);">
	...
	<div class="categolis">
		<table>
			<tr>
				<th>
					<a href="women/bathrobes.php" style="text-decoration: none;color: #ddd;padding: 4px 12px;background-color: #c7587e;border-radius: 12px;">bathrobes</a>
				</th>
				...
				<th><a href="women/hats.php" style="text-decoration: none;color: #ddd;padding: 4px 12px;background-color: #c7587e;border-radius: 12px;">hats</a></th>
				...
				<th><a href="women/toiletry1.php" style="text-decoration: none;color: #ddd;padding: 4px 12px;background-color: #c7587e;border-radius: 12px;">toiletry1</a></th>
			</tr>
		</table>
	</div>
